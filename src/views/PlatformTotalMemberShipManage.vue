...
import {
  ...
  selectBoxType,
  torderMemberListDataPlatformType,
} from '@interface/member';
import { CaretBottom, CaretTop } from '@element-plus/icons-vue';
import { PlatformAddMemberShipModal, PlatformDetailTotalMemberShipModal } from '@containers';
...
const torderCheckboxData = ref<torderMemberListDataPlatformType[]>([]);
const handleTorderSelect = (val: torderMemberListDataPlatformType[]) => {
...
/** 내부 회원 리스트 데이터 */
const torderMemberListData = ref<torderMemberListDataPlatformType[]>([]);
/** 내부 회원 리스트 데이터 불러오기 */
    ...
    .then(async () => {
      try {
        ...
        const requestData = {
          ...
          platform_member_state: isStateData
            ? undefined
            : collectiveDataInfo.state,
          platform_auth: isAuthData ? undefined : collectiveDataInfo.auth,
        };
...
const postExcelDownload = async () => {
  try {
    ...
    const requestURL = endpoints.excel.platform_member_list_download;
...
<template>
  ...
  >
    ...
    <el-table-column
      ...
      header-align="center"
      label="부서명"
      prop="platform_member_Department"
    />
    <el-table-column
      align="center"
      header-align="center"
    ...
    <el-table-column
      ...
      header-align="center"
      label="계정 상태"
      prop="platform_member_state"
    />
    <el-table-column
      align="center"
      header-align="center"
      label="발급일"
      prop="platform_member_register_datetime"
    />
    <el-table-column
      align="center"
      header-align="center"
    ...
    >
      <template #default="scope">
        <el-button
          type="info"
          @click="
            openModalWithData(DETAIL_TOTAL_MEMBERSHIP, scope.row.platform_id)
          "
        >
          상세
        </el-button>
